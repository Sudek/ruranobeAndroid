...
public class VolumeDTO {
  ...
  @SerializedName("imageTwo") @Expose private Integer imageTwo;
  @SerializedName("imageThree") @Expose private Integer imageThree;
  @SerializedName("imageFour") @Expose private Integer imageFour;
  @SerializedName("url") @Expose private String url;
  @SerializedName("nameFile") @Expose private String nameFile;
  ...
  @SerializedName("releaseDate") @Expose private Date releaseDate;
  @SerializedName("isbn") @Expose private String isbn;
  @SerializedName("externalUrl") @Expose private String externalUrl;
  ...
  @SerializedName("topicId") @Expose private Integer topicId;
  @SerializedName("requisiteId") @Expose private Integer requisiteId;
  @SerializedName("prevNameShort") @Expose private String prevNameShort;
  @SerializedName("prevUrl") @Expose private String prevUrl;
  @SerializedName("nextNameShort") @Expose private String nextNameShort;
  @SerializedName("nextUrl") @Expose private String nextUrl;
  @SerializedName("subProjectName") @Expose private String subProjectName;
